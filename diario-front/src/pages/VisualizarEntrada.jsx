                        ...
                        isImage ? (
                          ...
                          >
                            <source
                              ...
                              type={`${
                                media.tipoArquivo
                              }/${media.nomeOriginalArquivo.split(".").pop()}`}
                            />
                          ...
                          >
                            ...
                            <a
                              href={mediaUrl}
                              download={media.nomeOriginalArquivo}
                              style={{
                                color: "#52c41a",
                                fontSize: "0.8rem",
                                marginTop: "5px",
        ...
        {previewMediaUrl &&
          ...
          previewMediaUrl.includes(".pdf") ? (
            ...
            <div style={{ textAlign: "center" }}>
              <p>
                Prévia não disponível para este tipo de arquivo diretamente no
                navegador. Tente baixar:
              </p>
              <a
